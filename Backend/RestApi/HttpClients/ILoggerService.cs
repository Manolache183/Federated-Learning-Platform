...
namespace RestApi.HttpClients
{
    public interface ILoggerService
    {
        ...
        public abstract Task<bool> AddFileMetadata(string fileName, String FirebaseStorageID);
        public abstract Task<FileMetadata?> GetFileMetadata(string fileName);
        public abstract Task<bool> UpdateFileMetadata(string fileName, string filePath, String FirebaseStorageID);
